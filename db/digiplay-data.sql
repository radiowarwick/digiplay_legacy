...
insert into configuration values ( 8,'bin_weighting_2','9',0 ) ;
insert into configuration values ( 9,'bin_weighting_3','12',0 ) ;
insert into configuration values ( 10,'bin_weighting_4','14',0 ) ;
insert into configuration values ( 11,'bin_weighting_5','15',0 ) ;
insert into configuration values ( 12,'channel_1','/dev/dsp',1 ) ;
insert into configuration values ( 13,'channel_2','/dev/dsp1',1 ) ;
insert into configuration values ( 14,'channel_3','/dev/dsp2',1 ) ;
insert into configuration values ( 15,'channel_4','/dev/dsp3',1 ) ;
insert into configuration values ( 16,'next_on_showplan','',1 ) ;
insert into configuration values ( 17,'station_cartset','0',1 ) ;
insert into configuration values ( 18,'user_cartset','0',1 ) ;
insert into configuration values ( 19,'userid','2',1 ) ;
insert into configuration values ( 20,'player1_md5','',1 ) ;
insert into configuration values ( 21,'player2_md5','',1 ) ;
insert into configuration values ( 22,'player3_md5','',1 ) ;
alter sequence configuration_id_seq restart 23;
