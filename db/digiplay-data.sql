...
insert into configuration values ( 4,'auth_method','PSQL',-1 ) ;
insert into configuration values ( 5,'channel_1','/dev/dsp',0 ) ;
insert into configuration values ( 6,'bin_weighting_1','5',0 ) ;
insert into configuration values ( 7,'bin_weighting_2','9',0 ) ;
insert into configuration values ( 8,'bin_weighting_3','12',0 ) ;
insert into configuration values ( 9,'bin_weighting_4','14',0 ) ;
insert into configuration values ( 10,'bin_weighting_5','15',0 ) ;
insert into configuration values ( 11,'channel_1','/dev/dsp',1 ) ;
insert into configuration values ( 12,'channel_2','/dev/dsp1',1 ) ;
insert into configuration values ( 13,'channel_3','/dev/dsp2',1 ) ;
insert into configuration values ( 14,'channel_4','/dev/dsp3',1 ) ;
insert into configuration values ( 15,'next_on_showplan','',1 ) ;
insert into configuration values ( 16,'station_cartset','0',1 ) ;
insert into configuration values ( 17,'user_cartset','0',1 ) ;
insert into configuration values ( 18,'userid','2',1 ) ;
insert into configuration values ( 19,'player1_md5','',1 ) ;
insert into configuration values ( 20,'player2_md5','',1 ) ;
insert into configuration values ( 21,'player3_md5','',1 ) ;
alter sequence configuration_id_seq restart 22;
...
INSERT INTO cmscontent VALUES (7, 7, 1168015727, '<div align="center"><strong>You are now logged out</strong><br /></div><strong><br /></strong><div align="left">Click <a href="/">here</a> to go to the main homepage.<br /></div><div align="left">Click <a href="?templateID=11">here</a> to return to the Digiplay login page.</div>', 1);
INSERT INTO cmscontent VALUES (8, 8, 1171467945, '<strong>Other Features<br /></strong><a href="?templateID=19">Requested Tracks</a><br /><a href="?templateID=38">Censored Tracks<br /></a>', 1);
