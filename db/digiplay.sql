...
--    Time Created: 14 January 2006 11:04.
...
-- Create new table "audioext".
-- "audioext" : Table of audioext
-- 	"id" : id identifies audioext
-- 	"library_id" : library_id is of audioext
-- 	"title" : title is of audioext
-- 	"artist_name" : artist_name is of audioext
-- 	"album_name" : album_name is of audioext  
...
-- "playlist" : Table of playlist
-- 	"id" : id identifies playlist
-- 	"audio" : audio is of playlist
-- 	"playlist" : playlist is of playlist  
...
-- 	"start" : start is of binsschedule
-- 	"end" : end is of binsschedule
...
-- 	"rip_result" : rip_result is of audio  
create table "audio" ( 
	"id" SERIAL,
...
-- 	"dayofweek" : dayofweek is of taskschedule
-- 	"timeofday" : timeofday is of taskschedule  
...
-- 	"start" : start is of sustschedule
...
-- Add foreign key constraints to table "playlist".
...
-- Create table level triggers for table cartsaudio.
...
-- Create table level triggers for table email.
