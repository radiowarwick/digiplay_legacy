...
INSERT INTO cmscontent VALUES (5, 4, 1161102371, '<div align="center"><strong>The Studio Audiowalls<br /></strong><div align="left"><br />This section allows you to build your own personal audiowalls that can then be loaded into the studio AwWall. It provides access to:<br /><ul>    <li>Create new audiowall sets</li>    <li>Load in custom jingles</li>    <li>Select from a variety of button styles</li>    <li>View the current Station audiowall set</li>    <li>Manage the current Station audiowall set</li></ul></div></div>', 1);
