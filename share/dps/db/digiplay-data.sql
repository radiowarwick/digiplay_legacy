...
insert into configs values ( 1,'default_aw_set','The AudioWall set to be loaded when the user logs in' ) ;
...
insert into aw_styles (name, description) values ('Colour 01', 'Colour 01');
insert into aw_styles (name, description) values ('Colour 02', 'Colour 02');
insert into aw_styles (name, description) values ('Colour 03', 'Colour 03');
insert into aw_styles (name, description) values ('Colour 04', 'Colour 04');
insert into aw_styles (name, description) values ('Colour 05', 'Colour 05');
insert into aw_styles (name, description) values ('Colour 06', 'Colour 06');
insert into aw_styles (name, description) values ('Colour 07', 'Colour 07');
insert into aw_styles (name, description) values ('Colour 08', 'Colour 08');
insert into aw_styles (name, description) values ('Colour 09', 'Colour 09');
insert into aw_styles (name, description) values ('Colour 10', 'Colour 10');
insert into aw_styles (name, description) values ('Colour 11', 'Colour 11');
insert into aw_styles (name, description) values ('Colour 12', 'Colour 12');
insert into aw_styles (name, description) values ('Colour 13', 'Colour 13');
insert into aw_styles (name, description) values ('Colour 14', 'Colour 14');
insert into aw_styles (name, description) values ('Colour 15', 'Colour 15');
insert into aw_styles (name, description) values ('Colour 16', 'Colour 16');
insert into aw_styles (name, description) values ('Colour 17', 'Colour 17');
insert into aw_styles (name, description) values ('Colour 18', 'Colour 18');
insert into aw_styles (name, description) values ('Colour 19', 'Colour 19');
insert into aw_styles (name, description) values ('Colour 20', 'Colour 20');
insert into aw_styles (name, description) values ('Colour 21', 'Colour 21');
insert into aw_styles (name, description) values ('Colour 22', 'Colour 22');
insert into aw_styles (name, description) values ('Colour 23', 'Colour 23');
insert into aw_styles (name, description) values ('Colour 24', 'Colour 24');
insert into aw_styles (name, description) values ('Colour 25', 'Colour 25');
insert into aw_styles (name, description) values ('Colour 26', 'Colour 26');
insert into aw_styles (name, description) values ('Colour 27', 'Colour 27');
insert into aw_styles (name, description) values ('Colour 28', 'Colour 28');
insert into aw_styles (name, description) values ('Colour 29', 'Colour 29');
insert into aw_styles (name, description) values ('Colour 30', 'Colour 30');
insert into aw_styles (name, description) values ('Colour 31', 'Colour 31');
insert into aw_styles (name, description) values ('Colour 32', 'Colour 32');
insert into aw_styles (name, description) values ('Colour 33', 'Colour 33');
insert into aw_styles (name, description) values ('Colour 34', 'Colour 34');
insert into aw_styles (name, description) values ('Colour 35', 'Colour 35');
insert into aw_styles (name, description) values ('Colour 36', 'Colour 36');
alter sequence aw_styles_id_seq restart 37;

-- inserts for aw_styles_props
insert into aw_styles_props (style_id, prop_id, value) values (1, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (1, 2, 16708096);
insert into aw_styles_props (style_id, prop_id, value) values (2, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (2, 2, 16427802);
insert into aw_styles_props (style_id, prop_id, value) values (3, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (3, 2, 15894554);
insert into aw_styles_props (style_id, prop_id, value) values (4, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (4, 2, 16085287);
insert into aw_styles_props (style_id, prop_id, value) values (5, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (5, 2, 15747108);
insert into aw_styles_props (style_id, prop_id, value) values (6, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (6, 2, 15803433);
insert into aw_styles_props (style_id, prop_id, value) values (7, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (7, 2, 15342369);
insert into aw_styles_props (style_id, prop_id, value) values (8, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (8, 2, 15604775);
insert into aw_styles_props (style_id, prop_id, value) values (9, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (9, 2, 15408174);
insert into aw_styles_props (style_id, prop_id, value) values (10, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (10, 2, 15538246);
insert into aw_styles_props (style_id, prop_id, value) values (11, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (11, 2, 15537494);
insert into aw_styles_props (style_id, prop_id, value) values (12, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (12, 2, 15535461);
insert into aw_styles_props (style_id, prop_id, value) values (13, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (13, 2, 15401103);
insert into aw_styles_props (style_id, prop_id, value) values (14, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (14, 2, 11674772);
insert into aw_styles_props (style_id, prop_id, value) values (15, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (15, 2, 9055121);
insert into aw_styles_props (style_id, prop_id, value) values (16, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (16, 2, 7352981);
insert into aw_styles_props (style_id, prop_id, value) values (17, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (17, 2, 5058449);
insert into aw_styles_props (style_id, prop_id, value) values (18, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (18, 2, 3355030);
insert into aw_styles_props (style_id, prop_id, value) values (19, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (19, 2, 3027346);
insert into aw_styles_props (style_id, prop_id, value) values (20, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (20, 2, 3028116);
insert into aw_styles_props (style_id, prop_id, value) values (21, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (21, 2, 1852572);
insert into aw_styles_props (style_id, prop_id, value) values (22, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (22, 2, 23722);
insert into aw_styles_props (style_id, prop_id, value) values (23, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (23, 2, 27831);
insert into aw_styles_props (style_id, prop_id, value) values (24, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (24, 2, 33482);
insert into aw_styles_props (style_id, prop_id, value) values (25, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (25, 2, 44273);
insert into aw_styles_props (style_id, prop_id, value) values (26, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (26, 2, 43698);
insert into aw_styles_props (style_id, prop_id, value) values (27, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (27, 2, 43153);
insert into aw_styles_props (style_id, prop_id, value) values (28, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (28, 2, 43698);
insert into aw_styles_props (style_id, prop_id, value) values (29, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (29, 2, 108129);
insert into aw_styles_props (style_id, prop_id, value) values (30, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (30, 2, 42578);
insert into aw_styles_props (style_id, prop_id, value) values (31, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (31, 2, 42834);
insert into aw_styles_props (style_id, prop_id, value) values (32, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (32, 2, 173648);
insert into aw_styles_props (style_id, prop_id, value) values (33, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (33, 2, 44366);
insert into aw_styles_props (style_id, prop_id, value) values (34, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (34, 2, 5421380);
insert into aw_styles_props (style_id, prop_id, value) values (35, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (35, 2, 8242240);
insert into aw_styles_props (style_id, prop_id, value) values (36, 1, 0);
insert into aw_styles_props (style_id, prop_id, value) values (36, 2, 11324978);
alter sequence aw_styles_props_id_seq restart 73;
...
insert into configuration values ( 4,'ldap_filter','(objectClass=*)',-1 ) ;
insert into configuration values ( 5,'auth_method','PSQL',-1 ) ;
insert into configuration values ( 6,'contact_email','studio@example.com',-1 );
insert into configuration values ( 7,'contact_sms','01234567890',-1 );
insert into configuration values ( 8,'contact_phone','01234567890',-1 );
insert into configuration values ( 9,'search_limit','50',-1);
insert into configuration values ( 10,'censor_start','06',-1);
insert into configuration values ( 11,'censor_end','21',-1);
insert into configuration values ( 12,'playin_archive','',-1);
insert into configuration values ( 13,'channel_1','/dev/dsp',0 ) ;
insert into configuration values ( 14,'bin_weighting_1','5',0 ) ;
insert into configuration values ( 15,'bin_weighting_2','9',0 ) ;
insert into configuration values ( 16,'bin_weighting_3','12',0 ) ;
insert into configuration values ( 17,'bin_weighting_4','14',0 ) ;
insert into configuration values ( 18,'bin_weighting_5','15',0 ) ;
insert into configuration values ( 19,'channel_1','/dev/dsp',1 ) ;
insert into configuration values ( 20,'channel_2','/dev/dsp1',1 ) ;
insert into configuration values ( 21,'channel_3','/dev/dsp2',1 ) ;
insert into configuration values ( 22,'channel_4','/dev/dsp3',1 ) ;
insert into configuration values ( 23,'next_on_showplan','',1 ) ;
insert into configuration values ( 24,'station_aw_set','0',1 ) ;
insert into configuration values ( 25,'user_aw_set','0',1 ) ;
insert into configuration values ( 26,'userid','2',1 ) ;
insert into configuration values ( 27,'player1_md5','',1 ) ;
insert into configuration values ( 28,'player2_md5','',1 ) ;
insert into configuration values ( 29,'player3_md5','',1 ) ;
alter sequence configuration_id_seq restart 30;
...
INSERT INTO realms VALUES (35, 'Studio Audiowall', 21, 'Alter the studio Audiowall', 2, '03.21.34');
...
-- cmscontent
INSERT INTO cmscontent VALUES (1, 1, 1161100854, '<div align="center"><strong>The Digiplay Management system</strong><br /></div><br />This is a Beta version of the new Digiplay web management system. This means that it is likely that you will encounter some problems.<br /><br />Please forward any queries you have to the engineering team.<br /><br />If you receive an Authentication error when trying to access a page you beleive you should have access to please also contact the engineering team.', 1);
INSERT INTO cmscontent VALUES (2, 2, 1161101112, '<div align="center"><strong>The Music Library<br /></strong><div align="left"><br />The music library section of the webpage allows you to edit and manage the Music library, including:<br /></div><div align="left"><ul>    <li>Search the library</li>    <li>Editing track information</li>    <li>Commenting on track</li>    <li>Reporting tracks as unsuitable</li>    <li>Requesting new tracks for the library</li>    <li>And much more ...</li></ul>Watch this space for new and exciting developments.</div></div>', 1);
INSERT INTO cmscontent VALUES (3, 5, 1161101557, '<div align="center"><strong>Show Plans<br /></strong><div align="left"><br />The show plan section of this webpage is still in development but will soon allow you to create and plan personal showplans that you can load directly into the studio. This will allow you to create scripts incorperating:<br /></div><div align="left"><ul>    <li>Tracks from the Library<br />    </li>    <li>Scripts<br />    </li>    <li>Link information<br />    </li>    <li>External tracks</li></ul>Watch this space for new and exciting developments.</div></div>', 1);
INSERT INTO cmscontent VALUES (4, 3, 1161102133, '<div align="center"><strong>Sue Stamp Manager</strong><br /><strong><br /></strong><div align="left"><div align="center"><strong></strong><div align="left">This section of the webpage allows you to manage Digiplay\'s sustainer service (sue) It also allows you to view some statistics regarding the service.<br /><br />If you feel that you should have access to these tools please contact the engineering team.<br /></div></div></div></div>', 1);
INSERT INTO cmscontent VALUES (5, 4, 1161102371, '<div align="center"><strong>The Studio Audiowalls<br /></strong><div align="left"><br />This section allows you to build your own personal audiowalls sets that can then be loaded into the audiowall region in the studio. It provides access to:<br /><ul>    <li>Create new audiowall sets</li>    <li>Load in custom jingles</li>    <li>Select from a variety of button styles</li>    <li>View the current Station audiowall set</li>    <li>Manage the current Station audiowall set</li></ul></div></div>', 1);
INSERT INTO cmscontent VALUES (6, 6, 1168011808, '<div align="center"><strong>Public Help</strong><br /></div><br />This help will be available in the near future. In the meantime if you need help please contact the engineering team.', 1);
...
INSERT INTO fieldvalidators VALUES (16, 'DPSSystemAwSetEditValidator', 'Checks system can edit an audiowall set', 'DPS');
INSERT INTO fieldvalidators VALUES (17, 'DPSSystemAwWallEditValidator', 'Checks system can edit an audiowall', 'DPS');
INSERT INTO fieldvalidators VALUES (18, 'DPSSystemAwItemEditValidator', 'Checks system can edit an audiowall item', 'DPS');
INSERT INTO fieldvalidators VALUES (19, 'DPSUserAwSetEditValidator', 'Checks user can edit an audiowall set', 'DPS');
INSERT INTO fieldvalidators VALUES (20, 'DPSUserAwWallEditValidator', 'Checks user can edit an audiowall', 'DPS');
INSERT INTO fieldvalidators VALUES (21, 'DPSUserAwItemEditValidator', 'Checks user can edit an audiowall item', 'DPS');
INSERT INTO fieldvalidators VALUES (22, 'DPSSystemAwSetOwnValidator', 'Checks system owns a audiowall set', 'DPS');
INSERT INTO fieldvalidators VALUES (23, 'DPSSystemAwWallOwnValidator', 'Checks system owns a audiowall', 'DPS');
INSERT INTO fieldvalidators VALUES (24, 'DPSUserAudioEditValidator', 'Checks a user can write to an audio file', 'DPS');
INSERT INTO fieldvalidators VALUES (25, 'DPSSystemAwItemOwnValidator', 'Checks system owns an audiowall item', 'DPS');
INSERT INTO fieldvalidators VALUES (26, 'DPSUserAwSetOwnValidator', 'Checks user owns an audiowall set', 'DPS');
INSERT INTO fieldvalidators VALUES (27, 'DPSUserAwWallOwnValidator', 'Checks user owns an audiowall', 'DPS');
INSERT INTO fieldvalidators VALUES (28, 'DPSUserAwItemOwnValidator', 'Checks user owns an audiowall item', 'DPS');
INSERT INTO fieldvalidators VALUES (29, 'DPSSystemAwSetReadValidator', 'Checks system can read an audiowall set', 'DPS');
INSERT INTO fieldvalidators VALUES (30, 'DPSUserAwSetReadValidator', 'Checks user can read an audiowall set', 'DPS');
...
INSERT INTO fieldvalidators VALUES (40, 'DPSSystemAwItemDirWriteValidator', 'Checks edit permissions on containing directory', 'DPS');
INSERT INTO fieldvalidators VALUES (41, 'DPSSystemAwSetDirWriteValidator', 'Checks edit permissions on containing directory', 'DPS');
INSERT INTO fieldvalidators VALUES (42, 'DPSSystemAwWallDirWriteValidator', 'Checks edit permissions on containing directory', 'DPS');
INSERT INTO fieldvalidators VALUES (43, 'DPSUserAudioDirWriteValidator', 'Checks edit permissions on containing directory', 'DPS');
INSERT INTO fieldvalidators VALUES (44, 'DPSUserAwItemDirWriteValidator', 'Checks edit permissions on containing directory', 'DPS');
INSERT INTO fieldvalidators VALUES (45, 'DPSUserAwSetDirWriteValidator', 'Checks edit permissions on containing directory', 'DPS');
INSERT INTO fieldvalidators VALUES (46, 'DPSUserAwWallDirWriteValidator', 'Checks edit permissions on containing directory', 'DPS');
...
INSERT INTO forms VALUES (28, 'dpsUserDelAwSetForm', 'DPSUserDeleteAwSetModel', 'DPS', 19, NULL, NULL);
INSERT INTO forms VALUES (29, 'dpsUserActAwSetForm', 'DPSUserUpdateActAwSetModel', 'DPS', 19, NULL, NULL);
INSERT INTO forms VALUES (30, 'dpsUserNewAwSetForm', 'DPSUserAddAwSetModel', 'DPS', 19, NULL, NULL);
INSERT INTO forms VALUES (31, 'dpsUserAwWallEditForm', 'DPSUserUpdateAwWallModel', 'DPS', 19, NULL, NULL);
INSERT INTO forms VALUES (32, 'dpsUserAddAwWallPageForm', 'DPSUserAddAwWallModel', 'DPS', 19, NULL, NULL);
INSERT INTO forms VALUES (33, 'dpsUserAwItemAddForm', 'DPSUserAddAwItemModel', 'DPS', 19, NULL, NULL);
INSERT INTO forms VALUES (34, 'dpsUserAwItemEditForm', 'DPSUserUpdateAwItemModel', 'DPS', 19, NULL, NULL);
INSERT INTO forms VALUES (35, 'dpsStationNewAwSetForm', 'DPSStationAddAwSetModel', 'DPS', 39, NULL, NULL);
INSERT INTO forms VALUES (36, 'dpsStationDelAwSetForm', 'DPSStationDeleteAwSetModel', 'DPS', 39, NULL, NULL);
INSERT INTO forms VALUES (37, 'dpsStationActAwSetForm', 'DPSStationUpdateActAwSetModel', 'DPS', 39, NULL, NULL);
INSERT INTO forms VALUES (38, 'dpsStationAwWallEditForm', 'DPSStationUpdateAwWallModel', 'DPS', 39, NULL, NULL);
INSERT INTO forms VALUES (39, 'dpsStationAddAwWallPageForm', 'DPSStationAddAwWallModel', 'DPS', 39, NULL, NULL);
INSERT INTO forms VALUES (40, 'dpsStationAwItemEditForm', 'DPSStationUpdateAwItemModel', 'DPS', 39, NULL, NULL);
INSERT INTO forms VALUES (41, 'dpsStationAwItemAddForm', 'DPSStationAddAwItemModel', 'DPS', 39, NULL, NULL);
INSERT INTO forms VALUES (42, 'dpsStationAwItemDelForm', 'DPSStationDeleteAwItemModel', 'DPS', 39, NULL, NULL);
INSERT INTO forms VALUES (43, 'dpsUserAwItemDelForm', 'DPSUserDeleteAwItemModel', 'DPS', 19, NULL, NULL);
...
INSERT INTO forms VALUES (70, 'dpsUserMoveAwSetForm', 'DPSMoveAwSetModel', 'DPS', 19, NULL, NULL);
...
INSERT INTO formfields VALUES (11, 'dpsStationActAwSetForm', 'awset', 29, 'DPS');
INSERT INTO formfields VALUES (12, 'dpsStationDelAwSetForm', 'awset', 22, 'DPS');
INSERT INTO formfields VALUES (13, 'dpsStationAddAwWallPageForm', 'awset', 16, 'DPS');
INSERT INTO formfields VALUES (14, 'dpsStationAwWallEditForm', 'awset', 16, 'DPS');
INSERT INTO formfields VALUES (15, 'dpsStationAwItemAddForm', 'awwallID', 17, 'DPS');
INSERT INTO formfields VALUES (16, 'dpsStationAwItemEditForm', 'awitemID', 18, 'DPS');
INSERT INTO formfields VALUES (17, 'dpsUserDelAwSetForm', 'awset', 26, 'DPS');
INSERT INTO formfields VALUES (18, 'dpsUserActAwSetForm', 'awset', 30, 'DPS');
INSERT INTO formfields VALUES (19, 'dpsStationAwItemDelForm', 'awitemID', 18, 'DPS');
INSERT INTO formfields VALUES (20, 'dpsUserAddAwWallPageForm', 'awset', 19, 'DPS');
INSERT INTO formfields VALUES (21, 'dpsUserAwWallEditForm', 'awset', 19, 'DPS');
INSERT INTO formfields VALUES (22, 'dpsUserAwItemDelForm', 'awitemID', 21, 'DPS');
...
INSERT INTO formfields VALUES (29, 'dpsUserNewAwSetForm', 'name', 10, 'DPS');
INSERT INTO formfields VALUES (30, 'dpsUserNewAwSetForm', 'desc', 11, 'DPS');
INSERT INTO formfields VALUES (31, 'dpsUserAwWallEditForm', 'desc', 11, 'DPS');
INSERT INTO formfields VALUES (32, 'dpsUserAwWallEditForm', 'name', 10, 'DPS');
INSERT INTO formfields VALUES (33, 'dpsStationNewAwSetForm', 'name', 10, 'DPS');
INSERT INTO formfields VALUES (34, 'dpsStationNewAwSetForm', 'desc', 11, 'DPS');
INSERT INTO formfields VALUES (35, 'dpsStationAwWallEditForm', 'desc', 11, 'DPS');
INSERT INTO formfields VALUES (36, 'dpsStationAwWallEditForm', 'name', 10, 'DPS');
INSERT INTO formfields VALUES (37, 'dpsUserAwItemEditForm', 'text', 10, 'DPS');
INSERT INTO formfields VALUES (38, 'dpsUserAwItemEditForm', 'audioID', 31, 'DPS');
INSERT INTO formfields VALUES (39, 'dpsUserAwItemAddForm', 'text', 10, 'DPS');
INSERT INTO formfields VALUES (40, 'dpsUserAwItemAddForm', 'audioID', 31, 'DPS');
INSERT INTO formfields VALUES (41, 'dpsStationAwItemEditForm', 'text', 10, 'DPS');
INSERT INTO formfields VALUES (42, 'dpsStationAwItemEditForm', 'audioID', 31, 'DPS');
INSERT INTO formfields VALUES (43, 'dpsStationAwItemAddForm', 'text', 10, 'DPS');
INSERT INTO formfields VALUES (44, 'dpsStationAwItemAddForm', 'audioID', 31, 'DPS');
...
INSERT INTO formfields VALUES (80, 'dpsUserMoveAwSetForm', 'newParent', 2, 'DPS');
INSERT INTO formfields VALUES (81, 'dpsUserMoveScriptForm', 'scriptID', 39, 'DPS');
INSERT INTO formfields VALUES (82, 'dpsUserMoveAwSetForm', 'AwSetID', 19, 'DPS');
...
INSERT INTO templates VALUES (30, 'dpsststationviewawwall.tpl', 'DPSStationAwWallViewer', 39, 'DPS');
...
INSERT INTO templates VALUES (48, 'dpsuserAwSetmove.tpl', 'DPSUserAwSetMoveViewer', 19, 'DPS');
