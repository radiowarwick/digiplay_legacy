...
CREATE TABLE audioproperty (
    ...
    FOREIGN KEY (audio_id) REFERENCES audio (album_id),
...
CREATE TABLE property (
    ...
    FOREIGN KEY (property_group_id) REFERENCES propertygroup (property_group_id),
);
...
CREATE TABLE audiojinglepkg (
    ...
    FOREIGN KEY (audio_id) REFERENCES audio (audio_id),
    FOREIGN KEY (jingle_pkg_id) REFERENCES jinglepkg (jingle_pkg_id),
);
...
CREATE TABLE audiokeyword (
    ...
    FOREIGN KEY (audio_id) REFERENCES audio (audio_id),
    FOREIGN KEY (keyword_id) REFERENCES keyword (keword_id),
);
...
CREATE TABLE binartist (
    ...
    FOREIGN KEY (artist_id) REFERENCES artist (aritst_id),
...
CREATE TABLE binkeyword (
    ...
    FOREIGN KEY (kerword_id) REFERENCES keyword (keyword_id),
    FOREIGN KEY (bin_id) REFERENCES bin (bin_id),
);
...
CREATE TABLE cartaudio (
    ...
    FOREIGN KEY (audio_id) REFERENCES audio (audio_id),
    FOREIGN KEY (cart_style_id) REFERENCES cartstyle (cart_style_id),
    FOREIGN KEY (cart_id) REFERENCES cart (cart_id),
    FOREIGN KEY (cartwall_id) REFERENCES cartwall (cartwall_id),
);
...
CREATE TABLE cartstyleprop (
    ...
    FOREIGN KEY (cart_style_id) REFERENCES cartstyle (cart_style_id),
    FOREIGN KEY (cart_property_id) REFERENCES cartproperty (cart_property_id),
);
...
CREATE TABLE cartwall (
    ...
    FOREIGN KEY (cartset_id) REFERENCES cartset (cartset_id),
);
...
CREATE TABLE userprivilage (
    ...
    FOREIGN KEY (user_id) REFERENCES user (user_id),
    FOREIGN KEY (privilage_id) REFERENCES privilage (privilage_id),
);
...
CREATE TABLE showitem (
    ...
    FOREIGN KEY (show_plan_id) REFERENCES showplan (show_plan_id),
    FOREIGN KEY (audio_id) REFERENCES audio (audio_id),
...
CREATE TABLE sustschedule (
    ...
    FOREIGN KEY (audio_id) REFERENCES audio (audio_id),
    FOREIGN KEY (ext_feed_id) REFERENCES extfeed (ext_feed_id),
);
