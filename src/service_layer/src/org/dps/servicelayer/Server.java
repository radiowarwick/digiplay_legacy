...
import org.dps.servicelayer.cartset.CartsetService;

public final class Server {
    private Server() { }

    public static void main(String[] args) throws Exception {
        CartsetService bs = new CartsetService();
    ...
    private static void createRestService(Object serviceObj) {
        ...
        sf.setServiceClass(CartsetService.class);
    ...
    private static void createJsonRestService(Object serviceObj) {
        ...
        nstojns.put(Namespaces.CARTSET, "acme");
        nstojns.put(Namespaces.COMMON, "acme1");
        nstojns.put(Namespaces.DTO, "acme2");
        nstojns.put("http://cxf.apache.org/bindings/xformat", "acme3");
