...
void TabPanelInfo::draw() {
	...
	txtInfoPanel->setText( tr( "<H2>Quick Start</H2>\n"
		...
		"<P>The second tab above is an Audio Library search engine. It allows you to find music in the audio library to add to your playlist. Enter criteria for the track you are looking for and click search. Double click on a track to add it to the bottom of the show plan.</P>\n"
