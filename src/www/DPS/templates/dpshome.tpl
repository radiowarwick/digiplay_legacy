<html>
  ...
  <div class="home_titleBar">
    ...
    <div class="home_titleR">
      {templateLink id="71" text="<img src='DPS/images/hometitleExit.gif' alt='Exit'>"}
      {templateLink id="58" text="<img src='DPS/images/hometitleHelp.gif' alt='Help'>"}
      {if $VIEWER.Admin}
      {templateLink id="2" text="<img src='DPS/images/hometitleAdmin.gif' alt='Admin'>"}
      {/if}
    </div>
  </div>  
  <div class="home_navigateBar">
	...
	{templateLink id="76" text="<img src='DPS/images/homenavmusic.png' alt='Music Library'>"}
      </div>
      <div class="home_musicNavDesc">
	{templateLink id="76" text="Search for and edit music"}
      </div>
    </div>
    <div class="home_showNav">
      <div class="home_showNavTitle">
	{templateLink id="79" text="<img src='DPS/images/homenavshow.png' alt='Show Planning'>"}
      </div>
      <div class="home_showNavDesc">
	{templateLink id="79" text="Plan and schedule your show"}
      </div>
    </div>
    <div class="home_sueNav">
      <div class="home_sueNavTitle">
	{templateLink id="77" text="<img src='DPS/images/homenavsue.png' alt='Sue Stamp'>"}
      </div>
      <div class="home_sueNavDesc">
	{templateLink id="77" text="view and edit Sue playlist"}
      </div>
    </div>
    <div class="home_studioNav">
      <div class="home_studioNavTitle">
	{templateLink id="78" text="<img src='DPS/images/homenavstudio.png' alt='Studio Cartwalls'>"}
      </div>
      <div class="home_studioNavDesc">
	{templateLink id="78" text="Edit your jingles"}
      </div>
    </div>
  </div>
  <div class="home_content">
	...
	<table class="home_playlist">
	  <tr><th>Last track:</th><td>{$VIEWER.sueLastTrack.artist} - {templateLink id="55" text=$VIEWER.sueLastTrack.title _trackID=$VIEWER.sueLastTrack.id}</td></tr>
	  <tr><th>Next track:</th><td>{$VIEWER.sueNextTrack.artist} - {templateLink id="55" text=$VIEWER.sueNextTrack.title _trackID=$VIEWER.sueNextTrack.id}</td></tr>
	</table>
