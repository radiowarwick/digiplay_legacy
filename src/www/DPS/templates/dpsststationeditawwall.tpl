{include file="rfile:dpsstudiotopframe.tpl" title="RaW Digiplay Manager" studio="t" access_playlist=$VIEWER.access_playlist}
  ...
  <div class='awwallinfoR'>
    {templateLink id="27" text="<<< return to awwall profiles"}<br>
    {templateLink id="30" text="<<< preview awwall" _awset=$VIEWER.awsetID _page=$VIEWER.awwall.page}
  </div>
  <br style='clear: both;'>
  {if $VIEWER.permError == 't'}
    You do not have permission to edit this awwall.
  {else}
  <form name="dpsStationAwWallEditForm" method="post" action="{$CONFIG.general.siteRoot}">
  <input type="hidden" name="formName" value="dpsStationAwWallEditForm" />
  ...
  <table class="awwall">
	...
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=0&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem1.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td >
	{if $VIEWER.awitem2.audioid == "none"}
	<div class='EawitemBlank'>[BLANK]</div>
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=1&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem2.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td >
	{if $VIEWER.awitem3.audioid == "none"}
	<div class='EawitemBlank'>[BLANK]</div>
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=2&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem3.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
    </tr>
    <tr>
	...
	<div class='EawitemBlank'>[BLANK]</div>
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=3&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem4.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.awitem5.audioid == "none"}
	<div class='EawitemBlank'>[BLANK]</div>
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=4&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem5.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.awitem6.audioid == "none"}
	<div class='EawitemBlank'>[BLANK]</div>
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=5&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem6.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
    </tr>
    <tr>
	...
	<div class='EawitemBlank'>[BLANK]</div>
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=6&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem7.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.awitem8.audioid == "none"}
	<div class='EawitemBlank'>[BLANK]</div>
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=7&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem8.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.awitem9.audioid == "none"}
	<div class='EawitemBlank'>[BLANK]</div>
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=8&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem9.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
    </tr>
    <tr>
	...
	<div class='EawitemBlank'>[BLANK]</div>
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=9&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem10.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.awitem11.audioid == "none"}
	<div class='EawitemBlank'>[BLANK]</div>
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=10&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem11.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.awitem12.audioid == "none"}
	<div class='EawitemBlank'>[BLANK]</div>
	<div class='EawitemAdd'><a href="javascript:NewWindow('?templateID=29&awitemID=New&awitemPos=11&awwallID={$VIEWER.awwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EawitemChange'><a href="javascript:NewWindow('?templateID=29&awitemID={$VIEWER.awitem12.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
    </tr>
  </table>
  <div class='EawwallPerms'>
    {if $VIEWER.owner == 't'}
    {if $VIEWER.groupread}
