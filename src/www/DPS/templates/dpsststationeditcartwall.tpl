{include file="rfile:dpsstudiotopframe.tpl" title="RaW Digiplay Manager" studio="t" access_playlist=$VIEWER.access_playlist}
  ...
  <div class='cartwallinfoR'>
    {templateLink id="72" text="<<< return to cartwall profiles"}<br>
    {templateLink id="75" text="<<< preview cartwall" _cartset=$VIEWER.cartsetID _page=$VIEWER.cartwall.page}
  </div>
  <br style='clear: both;'>
  ...
  <div class='cartwallPage'>
	...
	{if $pages.id == $VIEWER.cartwall.page}
	  <b>{$pages.num}</b> 
	{else}
	  {templateLink id="74" text=$pages.num _cartset=$VIEWER.cartsetID _page=$pages.id} 
	{/if}
      {/foreach}
  ...
  <table class="cartwall">
	...
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=0&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart1.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td >
	{if $VIEWER.cart2.audioid == "none"}
	<div class='EcartBlank'>[BLANK]</div>
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=1&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart2.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td >
	{if $VIEWER.cart3.audioid == "none"}
	<div class='EcartBlank'>[BLANK]</div>
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=2&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart3.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
    </tr>
    <tr>
	...
	<div class='EcartBlank'>[BLANK]</div>
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=3&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart4.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.cart5.audioid == "none"}
	<div class='EcartBlank'>[BLANK]</div>
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=4&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart5.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.cart6.audioid == "none"}
	<div class='EcartBlank'>[BLANK]</div>
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=5&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart6.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
    </tr>
    <tr>
	...
	<div class='EcartBlank'>[BLANK]</div>
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=6&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart7.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.cart8.audioid == "none"}
	<div class='EcartBlank'>[BLANK]</div>
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=7&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart8.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.cart9.audioid == "none"}
	<div class='EcartBlank'>[BLANK]</div>
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=8&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart9.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
    </tr>
    <tr>
	...
	<div class='EcartBlank'>[BLANK]</div>
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=9&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart10.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.cart11.audioid == "none"}
	<div class='EcartBlank'>[BLANK]</div>
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=10&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart11.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
      <td>
	{if $VIEWER.cart12.audioid == "none"}
	<div class='EcartBlank'>[BLANK]</div>
	<div class='EcartAdd'><a href="javascript:NewWindow('?templateID=73&cartID=New&cartPos=11&cartwallID={$VIEWER.cartwall.id}','acepopup','640','480');">Add</a></div>
	{else}
	...
	<div class='EcartChange'><a href="javascript:NewWindow('?templateID=73&cartID={$VIEWER.cart12.id}','acepopup','640','480');">Change</a></div>
	{/if}
      </td>
    </tr>
  </table>
