...
*
*/
class DPSDirMoveValidator extends FormValidator {
	...
	public function isValid() {
		...
		if($this->fieldData['dirID'] == $this->fieldData['newParent']) {
			$invalidFields['form'] = "Can not select the same directory as parent";
		} elseif(!isset($invalidFields['dirID']) && !isset($invalidFields['newParent'])) {
			if($this->checkDir($this->fieldData['dirID'], $this->fieldData['newParent']) == true) {
				$invalidFields['form'] = "Can not move directory into a child";
			}
		}
