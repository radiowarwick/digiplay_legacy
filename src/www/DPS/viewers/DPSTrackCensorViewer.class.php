...
class DPSTrackCensorViewer extends Viewer {
  ...
  protected function setupTemplate() {
    ...
    $count_query = "SELECT count(audio.id) FROM audio WHERE audio.flagged='t'";
    $flaggedNum = $db->getOne($count_query);
    
    $query = "SELECT DISTINCT audio.title as title, audio.id as id FROM audio WHERE audio.flagged='t'";
    ...
    $count_query = "SELECT count(audio.id) FROM audio WHERE audio.censor='t'";
    $censoredNum = $db->getOne($count_query);
    
    $query = "SELECT DISTINCT audio.title as title, audio.id as id FROM audio WHERE audio.censor='t'";
