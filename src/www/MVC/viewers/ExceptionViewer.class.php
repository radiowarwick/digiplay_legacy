 ...
 * 
 */
class ExceptionViewer implements IViewer {
	...
	public function __construct($exception){
		...
		//findTemplate should not be used now becuase it needs database access (since 301)
		//$this->templateFileName = MVCUtils::findTemplate($cfg['smarty']['exceptionTemplateFile']);
		$this->templateFileName = $cfg['general']['toolkitRoot']. 
		                          '/' . $cfg['smarty']['exceptionTemplateModule'] . 
		                          '/templates/' . 
		                          $cfg['smarty']['exceptionTemplateFile'];
