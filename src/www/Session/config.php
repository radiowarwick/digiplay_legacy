...
$cfg['Session']['randomdata'] = 'g9YU9Cnbt3xvL0jrZKr3v5xoW2pLhCpzDd'; #CHANGE

//set to t to issue new random key every page request
//set to f to issue new random key only on login
$cfg['Session']['keypersession'] = 'f';
...
$cfg['Session']['deleteExpiredProb'] = 1;//0.0001;
