<?php /* Smarty version 2.6.14, created on 2006-09-22 18:54:19
         compiled from rfile:/var/www/toolkit/DPS/templates/dpssaddplaylist.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'templateLink', 'rfile:/var/www/toolkit/DPS/templates/dpssaddplaylist.tpl', 4, false),)), $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "rfile:dpssuetopframe.tpl", 'smarty_include_vars' => array('title' => 'RaW Digiplay Manager','nexttrack' => $this->_tpl_vars['VIEWER']['sueNextTrack'],'suesearchid' => $this->_tpl_vars['VIEWER']['templateID'],'Access_EditSue' => $this->_tpl_vars['VIEWER']['Access_EditSue'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	    <div class="musicTitle">Add to Sue Playlist</div>
 ...
 | 
	    ...
	    <div class="sueplaylistInfo1">
	      ...
	      Sort by artist
	      <?php else: ?>
	      <?php echo SmartyFunctions::SMARTY_templateLink(array('id' => '62','text' => 'Sort by artist','_dpsSearchLetter' => $this->_tpl_vars['VIEWER']['searchLetter'],'_dpsSortType' => 'artist','_dpsSearchType' => $this->_tpl_vars['VIEWER']['searchType'],'_dpsSearchVal' => $this->_tpl_vars['VIEWER']['searchValue']), $this);?>
	      ...
	      Sort by title
	      <?php else: ?>
	      <?php echo SmartyFunctions::SMARTY_templateLink(array('id' => '62','text' => 'Sort by title','_dpsSearchLetter' => $this->_tpl_vars['VIEWER']['searchLetter'],'_dpsSortType' => 'title','_dpsSearchType' => $this->_tpl_vars['VIEWER']['searchType'],'_dpsSearchVal' => $this->_tpl_vars['VIEWER']['searchValue']), $this);?>
	    ...
	    <form name="dpsSueAddPlaylistForm" method="post" action="<?php echo $this->_tpl_vars['CONFIG']['general']['siteRoot']; ?>
">
	      <input type="hidden" name="formName" value="dpsSueAddPlaylistForm" />
...
?>
		...
		<?php endif; ?>
		<td>
		  <?php if ($this->_tpl_vars['track']['sust'] == 't'): ?>
