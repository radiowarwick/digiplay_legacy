<?php /* Smarty version 2.6.14, created on 2006-12-17 18:47:17
         compiled from rfile:/var/www/DPS/templates/dpsshaddadvert.tpl */ ?>
<html>
  <head>
...
, Item: <?php echo $this->_tpl_vars['VIEWER']['item']['position']; ?>
    ...
    <hr>
    <div class=''>
      <form name="dpsUserAudioShow" method="post" action="<?php echo $this->_tpl_vars['CONFIG']['general']['siteRoot']; ?>
">
...
" />
				<input type="hidden" id="audioID" name="audioID" value="<?php echo $this->_tpl_vars['VIEWER']['item']['audio']; ?>
" />
      	<input type="text" id="niceName" name="niceName" readonly value="<?php echo $this->_tpl_vars['VIEWER']['item']['audioTitle']; ?>
" />
