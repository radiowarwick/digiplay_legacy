<?php /* Smarty version 2.6.14, created on 2006-12-23 20:51:35
         compiled from rfile:/var/www/DPS/templates/dpsuseraudiomove.tpl */ ?>
<html>
  <head>
  ...
  <body>
	...
	<?php else: ?>
		<div class='alignleft'>
			<div class='bigTitle'>Advanced Properties: <?php echo $this->_tpl_vars['VIEWER']['audio']['title']; ?>
</div>
			<form name="dpsUserMoveAudioForm" method="post" action="<?php echo $this->_tpl_vars['CONFIG']['general']['siteRoot']; ?>
">
    	  <input type="hidden" name="formName" value="dpsUserMoveAudioForm" />
				<input type="hidden" name="moduleName" value="DPS" />
				<input type="hidden" name="templateID" value="70" />
				<input type="hidden" name="audioID" value="<?php echo $this->_tpl_vars['VIEWER']['audio']['id']; ?>
" />
