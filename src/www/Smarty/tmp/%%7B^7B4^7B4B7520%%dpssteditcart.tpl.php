<?php /* Smarty version 2.6.14, created on 2006-09-25 13:33:49
         compiled from rfile:/var/www/toolkit/DPS/templates/dpssteditcart.tpl */ ?>
<html>
  <head>
...
<!-- Execution of the code that actually builds the specific tree.
  ...
  <body>
    ...
    <div class='EditCartDetails'>
      ...
      <form name="dpsUserCartEditForm" method="post" action="<?php echo $this->_tpl_vars['CONFIG']['general']['siteRoot']; ?>
">
...
" />
      <?php else: ?>
      <form name="dpsUserCartAddForm" method="post" action="<?php echo $this->_tpl_vars['CONFIG']['general']['siteRoot']; ?>
">
...
><?php echo $this->_tpl_vars['style']['name']; ?>
	...
	<?php endforeach; endif; unset($_from); ?>
      ...
      <?php if ($this->_tpl_vars['VIEWER']['new'] != 't'): ?>
      <form name="dpsUserCartDelForm" method="post" action="<?php echo $this->_tpl_vars['CONFIG']['general']['siteRoot']; ?>
">
