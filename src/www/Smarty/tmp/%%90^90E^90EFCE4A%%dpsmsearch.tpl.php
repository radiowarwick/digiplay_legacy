<?php /* Smarty version 2.6.14, created on 2007-01-22 10:18:11
         compiled from rfile:/var/www/DPS/templates/dpsmsearch.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'templateLink', 'rfile:/var/www/DPS/templates/dpsmsearch.tpl', 15, false),)), $this); ?>
...
">
		...
		<tr>
		  <?php if ($this->_tpl_vars['VIEWER']['EditTrack'] == 't'): ?>
		  <th> </th>
		  <?php endif; ?>
		  <th>Artist</th><th>Title</th><th>Preview</th>
		  <?php if ($this->_tpl_vars['VIEWER']['DeleteTrack'] == 't'): ?>
			<th>Swearing?</th> 
		  <th>
		  Delete
		  </th>
...
?>
		<tr>
		  ...
		  <td rowspan="2"><?php echo $this->_tpl_vars['track']['title']; ?>
</td>
		  ...
		  <td>
		    ...
		    <?php else: ?>
		    <?php if ($this->_tpl_vars['VIEWER']['ReportTrack'] == 't'): ?>
...
">
		...
		<tr>
			...
			<td colspan="2"><div class="music_mini"><?php echo $this->_tpl_vars['track']['length']; ?>
</div></td>
		</tr>
