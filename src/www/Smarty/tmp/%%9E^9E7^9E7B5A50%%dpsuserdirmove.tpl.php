<?php /* Smarty version 2.6.14, created on 2007-01-05 15:24:39
         compiled from rfile:/var/www/DPS/templates/dpsuserdirmove.tpl */ ?>
<html>
  <head>
  ...
  <body>
	...
	<?php else: ?>
		...
		<div class='alignleft'>
			...
			<form name="dpsUserMoveDirForm" method="post" action="<?php echo $this->_tpl_vars['CONFIG']['general']['siteRoot']; ?>
">
