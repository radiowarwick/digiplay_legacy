<?php /* Smarty version 2.6.14, created on 2006-09-20 15:38:16
         compiled from rfile:/var/www/toolkit/DPS/templates/dpseditcart.tpl */ ?>
<html>
  <head>
...
<!-- Execution of the code that actually builds the specific tree.
  ...
  <body>
    ...
    <div class='EditCartDetails'>
      ...
      <form name="dpsCartEditForm" method="post" action="<?php echo $this->_tpl_vars['CONFIG']['general']['siteRoot']; ?>
">
      <input type="hidden" name="formName" value="dpsCartEditForm" />
...
" />
      <?php else: ?>
      <form name="dpsCartAddForm" method="post" action="<?php echo $this->_tpl_vars['CONFIG']['general']['siteRoot']; ?>
">
      <input type="hidden" name="formName" value="dpsCartAddForm" />
      <input type="hidden" name="moduleName" value="DPS" />
      <input type="hidden" name="templateID" value="70" />
...
><?php echo $this->_tpl_vars['style']['name']; ?>
	...
	<?php endforeach; endif; unset($_from); ?>
      ...
      <div class='EditCartDetailSub'><input type="Submit" name="Submit" value="Submit">
      <?php if ($this->_tpl_vars['VIEWER']['new'] != 't'): ?>
