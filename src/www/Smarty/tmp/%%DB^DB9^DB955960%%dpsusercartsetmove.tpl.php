<?php /* Smarty version 2.6.14, created on 2006-12-23 21:03:48
         compiled from rfile:/var/www/DPS/templates/dpsusercartsetmove.tpl */ ?>
<html>
  <head>
  ...
  <body>
	...
	<?php else: ?>
		<div class='alignleft'>
			<div class='bigTitle'>Advanced Properties: <?php echo $this->_tpl_vars['VIEWER']['cartset']['name']; ?>
</div>
			<form name="dpsUserMoveCarsetForm" method="post" action="<?php echo $this->_tpl_vars['CONFIG']['general']['siteRoot']; ?>
">
    	  <input type="hidden" name="formName" value="dpsUserMoveCartsetForm" />
				<input type="hidden" name="moduleName" value="DPS" />
				<input type="hidden" name="templateID" value="70" />
				<input type="hidden" name="cartsetID" value="<?php echo $this->_tpl_vars['VIEWER']['cartset']['id']; ?>
" />
