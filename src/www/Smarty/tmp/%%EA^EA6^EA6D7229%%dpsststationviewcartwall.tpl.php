<?php /* Smarty version 2.6.14, created on 2006-09-21 23:02:52
         compiled from rfile:/var/www/toolkit/DPS/templates/dpsststationviewcartwall.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'templateLink', 'rfile:/var/www/toolkit/DPS/templates/dpsststationviewcartwall.tpl', 6, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
  <br>
  <br>
  <div class='cartwallTitle'>View Cartwall</div>
  <div class='cartwallinfoR'>
    ...
    <br><?php echo SmartyFunctions::SMARTY_templateLink(array('id' => '74','text' => "<<< edit cartwall",'_cartset' => $this->_tpl_vars['VIEWER']['cartsetID'],'_page' => $this->_tpl_vars['VIEWER']['cartwall']['page']), $this);?>
...
?>
	...
	<?php else: ?>
	  <?php echo SmartyFunctions::SMARTY_templateLink(array('id' => '75','text' => $this->_tpl_vars['pages']['num'],'_cartset' => $this->_tpl_vars['VIEWER']['cartsetID'],'_page' => $this->_tpl_vars['pages']['id']), $this);?>
