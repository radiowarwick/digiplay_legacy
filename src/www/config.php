 ...
 */
//$cfg['general']['domain'] = 'www.radio.warwick.ac.uk'; #CHECK
$cfg['general']['domain'] = 'www.radio.warwick.ac.uk'; #CHECK
/*
...
*/
$cfg['general']['siteRoot'] = '/dps-dev/'; #CHECK
	

//The protocol to be used. Normally 'http://' (or 'https://' if using SSL)
$cfg['general']['protocol'] = 'https://'; #CHECK

// The path to the toolkit root directory
$cfg['general']['toolkitRoot'] = '/var/www'; #CHANGE
